// automatically generated by the FlatBuffers compiler for C++ serialization, do not modify
...
struct InotifyBuilder {
  ...
  void add_size_limit(uint32_t size_limit) {
    fbb_.AddElement<uint32_t>(Inotify::VT_SIZE_LIMIT, size_limit, 0);
  }
...
struct InotifyPathUpdated FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<int8_t> *trigger_events() const {
    return GetPointer<const ::flatbuffers::Vector<int8_t> *>(VT_TRIGGER_EVENTS);
  }
  uint32_t size() const {
    return GetField<uint32_t>(VT_SIZE, 0);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_PATH) &&
           verifier.VerifyString(path()) &&
           VerifyOffset(verifier, VT_TRIGGER_EVENTS) &&
           verifier.VerifyVector(trigger_events()) &&
           VerifyField<uint32_t>(verifier, VT_SIZE, 4) &&
           verifier.EndTable();
  }
};
...
struct InotifyPathUpdatedBuilder {
  ...
  void add_trigger_events(::flatbuffers::Offset<::flatbuffers::Vector<int8_t>> trigger_events) {
    fbb_.AddOffset(InotifyPathUpdated::VT_TRIGGER_EVENTS, trigger_events);
  }
  void add_size(uint32_t size) {
...
inline ::flatbuffers::Offset<InotifyPathUpdated> CreateInotifyPathUpdated(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::String> path = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<int8_t>> trigger_events = 0,
    uint32_t size = 0) {
...
inline ::flatbuffers::Offset<InotifyPathUpdated> CreateInotifyPathUpdatedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    const char *path = nullptr,
    const std::vector<int8_t> *trigger_events = nullptr,
    uint32_t size = 0) {
  auto path__ = path ? _fbb.CreateString(path) : 0;
  auto trigger_events__ = trigger_events ? _fbb.CreateVector<int8_t>(*trigger_events) : 0;
