...
const ENUM_MIN_EQUIPEMENT: u8 = 0;
const ENUM_MAX_EQUIPEMENT: u8 = 1;
...
impl flatbuffers::EndianScalar for Equipement {
  ...
  fn to_little_endian(self) -> Self {
    ...
    let p = &n as *const u8 as *const Equipement;
    unsafe { *p }
  }
  #[inline]
  fn from_little_endian(self) -> Self {
...
impl flatbuffers::Push for Equipement {
    ...
    #[inline]
    fn push(&self, dst: &mut [u8], _rest: &[u8]) {
        flatbuffers::emplace_scalar::<Equipement>(dst, *self);
    }
}

#[allow(non_camel_case_types)]
const ENUM_VALUES_EQUIPEMENT:[Equipement; 2] = [
  Equipement::NONE,
  Equipement::Weapon
];

#[allow(non_camel_case_types)]
const ENUM_NAMES_EQUIPEMENT:[&'static str; 2] = [
    "NONE",
    "Weapon"
];

pub fn enum_name_equipement(e: Equipement) -> &'static str {
  let index = e as u8;
  ENUM_NAMES_EQUIPEMENT[index as usize]
}
...
impl<'a> Monster<'a> {
  ...
  pub fn equipped_type(&self) -> Equipement {
    self._tab.get::<Equipement>(Monster::VT_EQUIPPED_TYPE, Some(Equipement::NONE)).unwrap()
  }
  #[inline]
